...
const perfis_1 = __importDefault(require("./routes/perfis"));
const graduacoes_1 = __importDefault(require("./routes/graduacoes"));
const mentores_1 = __importDefault(require("./routes/mentores"));
const mentor_disciplinas_1 = __importDefault(require("./routes/mentor-disciplinas"));
const estudantes_1 = __importDefault(require("./routes/estudantes"));
